...
public record ShoppingItemResponse(Guid Id, Guid IngredientId, string Name, string? Category, bool IsChecked, DateTime AddedAt);
public record AddShoppingItemRequest(Guid IngredientId);
